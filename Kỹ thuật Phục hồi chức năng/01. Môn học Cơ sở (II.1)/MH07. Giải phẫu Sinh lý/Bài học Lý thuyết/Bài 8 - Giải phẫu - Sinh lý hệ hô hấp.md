...
![[he_ho_hap_thanh_quan_co_table.png]]
...
- **Niêm mạc thanh quản**: phủ mặt trong của thanh quản và các dây thanh âm tạo thành nếp thanh âm trên và dưới. Khoảng hẹp giữa nếp thanh âm dưới là thanh môn. Các dây thanh âm tham gia vào quá trình phát âm.
### 1.3.6 Chức năng
...
## 1.4 Khí Quản (_Trachea_)
Khí quản là một ống dẫn khí hình trụ, dẹt ở phía sau, nối tiếp từ thanh quản xuống đến phân nhánh phế quản.
![[he_ho_hap_khi_quan_1.jpeg]]
![[he_ho_hap_khi_quan_2.png]]

### 1.4.1 Vị trí (_Location_)
- **Điểm bắt đầu:** Nối tiếp bờ dưới của sụn nhẫn (_cricoid cartilage_), tương ứng ngang đốt sống cổ C6.
- **Điểm kết thúc:** Đi xuống qua gờ trên lồng ngực vào trung thất giữa, kết thúc tại điểm chia đôi thành 2 phế quản chính (_tracheal bifurcation_), tương ứng ngang đốt sống ngực T4-T5 (hoặc ngang góc xương ức - _sternal angle / angle of Louis_).
    
- **Phân đoạn:** Được chia làm 2 đoạn:
	...
	- **Đoạn cổ (_cervical part_).**
		...
		-  Liên quan
			...
			+ Hai bên liên quan thuỳ bên của tuyến giáp và bó mạch thần kinh cổ.
...
### 1.4.2 Hình thái & Cấu trúc trong (_Morphology & Internal Features_)
- **Kích thước:** Dài khoảng 10–12 cm, đường kính khoảng 1 (1,5 - 2) cm.
    
- **Cựa khí quản (_Carina_):** Là gờ sụn nhô lên ở lòng trong khí quản, ngay tại vị trí chia đôi thành 2 phế quản chính (_right/left main bronchus_). Đây là khu vực rất nhạy cảm, dễ kích thích gây phản xạ ho mạnh khi có dị vật.
### 1.4.3 Cấu tạo (_Structure_)
Khí quản được cấu tạo bởi **16–20 vòng sụn trong hình chữ D (_tracheal cartilages_)**, khuyết ở mặt sau.
![[he_ho_hap_khi_quan_3.jpeg]]
![[he_ho_hap_khi_quan_5.png]]

- **Lớp niêm mạc (_Mucosa_):** 
	- Lớp biểu mô trụ giả tầng có lông chuyển (_pseudostratified ciliated columnar epithelium_) chứa nhiều tế bào đài tiết nhầy (_goblet cells_).
	- Lớp lót ở mặt trong cùng của lòng khí quản.
	- **Nhiệm vụ:** Giữ lại bụi bẩn, vi khuẩn và đẩy chúng ngược lên phía hầu nhờ nhịp đập của lông chuyển.
    
- **Lớp dưới niêm mạc (_Submucosa_):** Chứa mô liên kết thưa, mạch máu và các tuyến tiết nhầy-dịch (_seromucous glands_).
    
- **Lớp sụn - cơ- màng (_Fibrocartilaginous layer_):**
    
    - **Vòng sụn khí quản (_Tracheal cartilage_):** 
	    - Giúp giữ cho lòng khí quản luôn mở rộng, không bị xẹp khi hít vào.
	    - Là các vòng sụn trong (_hyaline cartilage_) hình chữ D hay hình móng ngựa (khoảng 16–20 vò
	    - **Nhiệm vụ:** Tạo khung vững chắc, giữ cho lòng khí quản luôn mở rộng và không bị xẹp xuống khi hít vào.
        
    - **Dây chằng vòng (_Anular ligaments_):** Nối giữa các vòng sụn với nhau.
        
    - **Cơ trơn khí quản (_Trachealis muscle_):** Cơ trơn nối hai đầu hở của sụn chữ U ở phía sau. Khi cơ này co lại sẽ làm hẹp lòng khí quản, tăng áp lực không khí khi ho (co lại khi ho để tăng áp lực đẩy khí/dị vật ra ngoài)..
...
- **Làm sạch và bảo vệ (_Cleansing & Protection_):** Thảm chất nhầy bẫy bụi bẩn, vi khuẩn; hệ thống lông chuyển (_cilia_) đập theo nhịp đẩy chất nhầy lên hầu để nuốt hoặc khạc ra ngoài (cơ chế _mucociliary escalator_).
    
- **Điều hòa nhiệt độ & độ ẩm (_Conditioning air_):** Làm ấm và làm ẩm không khí trước khi đi vào phổi.
