...
> [!NOTE] Học thêm
> https://youtu.be/QxcJkRFHsFA
> https://youtu.be/fG7o8e55fDc
> https://youtu.be/nEfsamHFQPU
...
![[kich_thuoc_tim1.png]]
- Trục của tim sẽ được quan sát theo các thứ tự như sau
	- Phải => Trái
	- Trên => Dưới 
	- Trước => Sau 
...
- Còn gọi là mặt trước, có 2 rãnh lớn 
	...
	- **Rãnh gian thất trước (Anterior interventricular groove)**: chia theo chiều dọc
		- Ranh giới: Chia tầng tâm thất ở mặt trước thành tâm thất phải (chiếm 2/3 diện tích) và tâm thất trái (chiếm 1/3 diện tích). 
		- Thành phần trong rãnh: 
			- Nhánh gian thất trước của động mạch vành trái (động mạch xuống trước trái - LAD).  
			+ Tĩnh mạch tim lớn (đoạn chạy dọc phía trước). 
		- Hướng đi và điểm tận cùng: 
			+ Chạy dọc chéo từ rãnh vành hướng xuống dưới về phía đỉnh tim. 
			+ Kết thúc ở bên phải đỉnh tim (tạo nên khuyết đỉnh tim), nối tiếp với rãnh gian thất sau ở mặt hoành.
...
![[tim_mat_hoanh_1.png]]
![[tim_mat_hoanh_2.png]]
- Đè lên cơ hoành, liên quan đến thùy trái của gan, dạ dày và đáy vị
- Có 2 rãnh 
	- **Rãnh Vành (Coronary sulcus)**
		- **Ranh giới:** Tiếp tục chạy ngang để phân chia tầng tâm nhĩ (ở trên) và tầng tâm thất (ở dưới). Ở mặt này, tầng nhĩ lộ rõ hơn mặt trước và không bị các động mạch lớn che khuất.
		- Thành phần trong rãnh:
			- **Xoang tĩnh mạch vành (Coronary sinus):** Một đoạn phình lớn màu xanh dương nằm ngay trung tâm rãnh vành mặt sau, nơi thu nhận hầu hết máu tĩnh mạch của tim trước khi đổ về tâm nhĩ phải.
			- **Động mạch vành phải** (chạy ở nửa bên phải hình).
			- **Nhánh mũ của động mạch vành trái** và **Tĩnh mạch tim lớn** (chạy ở nửa bên trái hình).
	- **Rãnh gian thất sau (Posterior interventricular groove)**
		- **Ranh giới:** Chia tầng tâm thất ở mặt hoành thành tâm thất trái và tâm thất phải.
			- _Lưu ý (Ngược với mặt trước):_ Ở mặt hoành, **tâm thất trái chiếm diện tích lớn hơn** (khoảng 2/3 diện tích, nằm bên trái hình), còn **tâm thất phải chiếm diện tích nhỏ hơn** (khoảng 1/3 diện tích, nằm bên phải hình).
		- Thành phần trong rãnh:
			- **Nhánh gian thất sau của động mạch vành phải** (hay còn gọi là _động mạch xuống sau_).
			- **Tĩnh mạch tim giữa** (chạy song song song với động mạch).
...
- **Chức năng:**
    - Tạo bề mặt trơn trượt giúp máu lưu thông mượt mà, **ngăn ngừa hình thành cục máu đông**.
    - Liên tục và xếp gấp lại để **tạo nên các van tim** (van 2 lá, van 3 lá, van động mạch chủ, van động mạch phổi), giúp máu chỉ chảy theo một chiều cố định.
### 1.1.5 Mạch máu và thần kinh (liên quan đến tim)
![[tim_1.png]]
#### 1.1.5.1 Mạch máu 
Tim tự nuôi dưỡng mình bằng **hệ động mạch vành** (xuất phát ngay gốc động mạch chủ) và dẫn máu về qua **hệ tĩnh mạch vành**.
##### A. Động mạch vành (Nguồn nuôi tim)
Gồm 2 nhánh chính chạy trên bề mặt tim:
- **Động mạch vành trái (Left Coronary Artery):**
    - Chia làm 2 nhánh quan trọng: _Nhánh liên thất trước_ (nuôi mặt trước và mỏm tim) và _Nhánh mũ_ (nuôi mặt sau/bên thất trái).
    - **Đặc điểm:** Nuôi dưỡng diện tích rất lớn (hầu hết thất trái) — nếu tắc nhánh này nguy cơ tử vong cao.
- **Động mạch vành phản (Right Coronary Artery):**
    - Chạy xuống mặt sau, nuôi thất phải, một phần mặt sau thất trái và hệ thống nút phát nhịp (nút xoang).
        
> **Ghi chú quan trọng:** Động mạch vành là **động mạch tận** (rất ít vòng nối tiếp). Nếu bị tắc do cục máu đông hay mảng xơ vữa $\rightarrow$ gây **nhồi máu cơ tim** (vùng cơ tương ứng bị hoại tử).
##### B. Tĩnh mạch vành (Dẫn máu về)
- Máu tĩnh mạch thu gom qua các tĩnh mạch tim (tim lớn, tim giữa, tim nhỏ...).
- Tất cả đổ về **Xoang tĩnh mạch vành** (mặt sau tim) $\rightarrow$ rồi trực tiếp đổ vào **tâm nhĩ phải**.
#### 1.1.5.2 Thần kinh 
Tim hoạt động nhờ 2 hệ thống thần kinh song song: **Tự động (nội tại)** và **Tự chủ (ngoại tại)**.
##### A. Hệ thống dẫn truyền tự động (Nội tại)
Tim có thể tự đập kể cả khi cắt đứt thần kinh nối với cơ thể nhờ các cụm tế bào đặc biệt:
1. **Nút xoang ( keith - flack / SA node):** Nằm ở nhĩ phải — được mệnh danh là _"Nút chỉ huy"_ (phát nhịp 60–100 lần/phút).
2. **Nút thất nhĩ (Aschoff - Tawara / AV node):** Nhận tín hiệu từ nhĩ, làm chậm tín hiệu một chút để nhĩ kịp bóp hết máu xuống thất.
3. **Bó His & Sợi Purkinje:** Truyền xung điện nhanh chóng xuống hai thất để tâm thất co bóp đồng bộ.

##### B. Hệ thần kinh tự chủ (Ngoại tại)
Đóng vai trò điều chỉnh tốc độ/lực co bóp của tim theo nhu cầu cơ thể:
- **Hệ giao cảm (Sympathetic):** Làm **tăng** nhịp tim, tăng lực co bóp, co mạch (kích hoạt khi vận động, căng thẳng, sợ hãi).
- **Hệ đối giao cảm / Phó giao cảm (Parasympathetic - qua Dây thần kinh X):** Làm **giảm** nhịp tim, giảm lực co bóp (khi nghỉ ngơi, thư giãn).
